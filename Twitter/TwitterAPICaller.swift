...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    ...
    func postTweet(tweetString:String, success: @escaping () -> (), failure: @escaping (Error) -> ()){
        ...
        let url = "https://api.twitter.com/1.1/statuses/update.json" //POST status/update endpoint from Twitter API https://developer.twitter.com/en/docs/twitter-api/v1/tweets/post-and-engage/api-reference/post-statuses-update
